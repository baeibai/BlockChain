      ...
      <div class="row justify-content-center">
        <div class="col-sm-8 text-center">
          <div class="iq-comingsoon-info">
            <a href="#">
              <router-link :to="{ name: 'social.list'}" class="d-flex justify-content-center align-items-center gap-2 iq-header-logo">
            ...
            <ul class="countdown row list-inline" data-date="Dec 31 2022 23:59:59">
